...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.css"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="{{ asset('lure/css/custom.css?'.time())}}">
                    ...
                    <div class="col-md-4">
                        <div class="link_footer">
                            ...
                            <ul>
                                ...
                                <li><a href="{{ request()->routeIs('home') ? '#model_section' : url('/#model_section') }}">Our Models</a></li>
                                <li><a href="{{ request()->routeIs('home') ? '#about_section' : url('/#about_section') }}">About</a></li>
                                <li><a href="{{ request()->routeIs('home') ? '#services_section' : url('/#services_section') }}">Services</a></li>
                                <li><a href="{{ request()->routeIs('home') ? '#footer_section' : url('/#footer_section') }}#footer_section">Contact</a></li>
                                <li><a href="{{ request()->routeIs('home') ? '#result_section' : url('/#result_section') }}">Results</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-2">
