        ...
        <div class="videos_compare_block">
            ...
            <div class="video_col">
                <div class="live-stream new_stream">
                    ...
                    <!-- <img src="{{asset('lure/images/Shot With 4k Camera.png')}}" class="image_with"> -->
                </div>
            </div>
        </div>
    </div> 
            ...
            <div class="container">
                <div class="dominate_content p_140">
                    @if(isset($homecontent->contentSec_simage) && $homecontent->contentSec_simage != null)
                        <img class="hot_grl" src="{{ asset('lure/images') }}/{{ $homecontent->contentSec_simage}}" onerror="this.src={{ asset('lure/images/ai-beautiful-hot-girl-png-image 1.png') }}">
                    @else 
