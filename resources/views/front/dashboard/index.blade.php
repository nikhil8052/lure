...
<div class="top_section_wrap move_container">
    <div class="banner">
        ...
        <div class="banner_top text-center">
            <h3 class="banner_sub_head">BREAKING THE NORMAL.</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text_col">
                                <div class="text_block">
                                    <p class="size26">As a leading OnlyFans management agency, we use proven strategies to grow your revenue.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 more_text_col">
                            <div class="more_text_div">
                                <div class="more_free_text">
                                    <div class="changebox">
                                        <span class="pink">More Free Time </span>
...
@if(isset($services) && $services != null)
    <section class="services horizontal_scrub_slider" id="services_section">
    ...
    <div class="container">
        <div class="agency_wrap">
            <div class="agency_hedibg_col">
                <h4>Expert’s Pick: <br> Top Rated OnlyFans Agency</h4>
            </div>
    ...
    <div class="container">
        <div class="section_inner" style="background-image:url(images/gradient_section_bg.png)";>
            <div class="tabs_button">
                ...
                <img src="{{ asset('lure/images/lottie.svg') }}" class="lotie_abs">
            </div>
                    ...
                    <div class="crad_inner">
                        ...
                        <div class="stats">
                            <div class="profile_image">
                                <img src="{{ asset('lure/images/Rectangle 106.png') }}">
                            </div>
...
<section class="accordion_sec p100">
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="join-us-txt">
                        <h2>Join Us Today</h2>
                        <p>Whether you’re starting fresh or want to scale an existing account, we can help you
                ...
                <div class="col-md-5">
                    <div class="apply-img">
                        <img src="{{ asset('lure/images/apply-now.png') }}" alt="">
    ...
    <div class="divider p100" id="faq_block">
        <div class="container-fluid text-center">
            <img src="{{ asset('lure/images/line.png') }}">
        </div>
    </div>
