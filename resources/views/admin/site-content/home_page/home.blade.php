                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Home Settings</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-bordered card-stretch">
                            <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#site" aria-selected="true" role="tab"><em class="icon ni ni-laptop"></em><span>Banner Section</span></a>
                                </li>
                                {{-- <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-bs-toggle="tab" href="#socialMedia" aria-selected="false" tabindex="-1" role="tab"><em class="icon ni ni-user-alt"></em><span> Links</span></a>
                                </li> --}}
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="site" role="tabpanel">
                                    <div class="card-inner pt-0">
                                        <h4 class="title nk-block-title">Banner section</h4>
                                        <p>Here is your Content of home page Banner.</p>
                                        <form action="#" class="gy-3 form-settings">
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        <label class="form-label" for="comp-name">Banner Title</label>
                                                        <span class="form-note">Specify the title of your Home Page.</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="form-group">
                                            ...
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        <label class="form-label" for="comp-email">Video Url</label>
                                                        <span class="form-note">Specify the Background video Url.</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="form-group">
