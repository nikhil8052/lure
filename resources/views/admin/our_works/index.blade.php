...
@section('content')
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="site" role="tabpanel">
                                    <div class="card-inner pt-0">
                                        <h4 class="title nk-block-title">What we do?</h4>
                                        <!-- <p></p> -->
                                        <form action="{{ route('add.works') }}" id="serviceForm" method="POST" enctype="multipart/form-data" class="gy-3 form-settings">
                                            @csrf
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control serviceinput" name="title" placeholder="We take care" id="title" value="{{ $results->title ?? '' }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            @if(isset($results) && $results->works != null && !empty(json_decode($results->works,true)))
                                                <div class="parent_container_div">
                                                    <!-- <h6 class="title nk-block-title">Results</h6> -->
                                                    <div id="servic_container_div" class="p-2">
                                                        @foreach (json_decode($results->works,true) as $data)
                                                            @if($loop->iteration == 1)
                                                        ...
                                                        <div class="row g-3 p-2  totalServices">
                                                            <div class="col-lg-5">
                                                                <div class="form-group">
                                                                    <label for="">Title</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" class="form-control serviceinput" name="result[1][heading]"   >
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Image</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="file" class="form-control serviceinput" name="result[1][image]"   >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap">
                                                                        <label for="">Description</label>
                                                                        <div class="form-control-wrap">
                                                                            <textarea style="min-height: 120px" class="form-control form-control serviceinput"  name="result[1][description]"  placeholder="Lorem ipsum...."></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row g-3 p-2  totalServices">
                                                            <div class="col-lg-5">
                                                                <div class="form-group">
                                                                    <label for="">Title</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" class="form-control serviceinput" name="result[2][heading]"   >
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Image</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="file" class="form-control serviceinput" name="result[2][image]"   >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap">
                                                                        <label for="">Description</label>
                                                                        <div class="form-control-wrap">
                                                                            <textarea style="min-height: 120px" class="form-control form-control serviceinput"  name="result[2][description]"  placeholder="Lorem ipsum...."></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
    ...
    <script>
        ...
        //     @if(isset($results) && $results->works != null && !empty(json_decode($results->works,true)))
        //         let totalresults = "{{ count(json_decode($results->works,true)) }}";
        //     @else
        //         let totalresults = 0;
        //     @endif
